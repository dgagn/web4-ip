...
<test-component delay="150" {{$attributes->merge(['class' => 'transition-opacity bg-' . $type . '-200 opacity-100 dark:bg-' . $type . '-200/30 p-sm flex justify-between rounded-md'])}} oncloseclass="!opacity-0">
    <div class="flex">
